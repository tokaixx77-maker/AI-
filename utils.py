...
DEFAULT_STANDARDS_DATA = {
    "小学(低年级)": {
        "说明": "适用于小学1-2年级",
        "男": {"50米": {"60": 12.0, "80": 10.6}, "坐位体前屈": {"60": -0.6, "80": 6.9}, "立定跳远": {"60": 117, "80": 140}, "跳绳": {"60": 17, "80": 80}, "肺活量": {"60": 680, "80": 1080}},
        "女": {"50米": {"60": 12.6, "80": 11.2}, "坐位体前屈": {"60": 1.6, "80": 8.7}, "立定跳远": {"60": 110, "80": 132}, "跳绳": {"60": 17, "80": 84}, "肺活量": {"60": 580, "80": 900}}
    },
    "小学(中年级)": {
        "说明": "适用于小学3-4年级",
        "男": {"50米": {"60": 10.6, "80": 9.2}, "坐位体前屈": {"60": 0.5, "80": 8.0}, "立定跳远": {"60": 138, "80": 161}, "跳绳": {"60": 40, "80": 95}, "仰卧起坐": {"60": 23, "80": 39}, "肺活量": {"60": 1100, "80": 1700}},
        "女": {"50米": {"60": 10.8, "80": 9.5}, "坐位体前屈": {"60": 2.8, "80": 9.8}, "立定跳远": {"60": 130, "80": 149}, "跳绳": {"60": 42, "80": 99}, "仰卧起坐": {"60": 21, "80": 37}, "肺活量": {"60": 950, "80": 1350}}
    },
    "小学(高年级)": {
        "说明": "适用于小学5-6年级",
        "男": {"50米": {"60": 9.8, "80": 8.6}, "坐位体前屈": {"60": 2.0, "80": 9.0}, "立定跳远": {"60": 161, "80": 193}, "跳绳": {"60": 65, "80": 126}, "仰卧起坐": {"60": 28, "80": 42}, "50x8往返跑": {"60": 138, "80": 122}, "肺活量": {"60": 1400, "80": 2200}},
        "女": {"50米": {"60": 10.2, "80": 9.1}, "坐位体前屈": {"60": 4.5, "80": 10.5}, "立定跳远": {"60": 139, "80": 164}, "跳绳": {"60": 67, "80": 129}, "仰卧起坐": {"60": 27, "80": 41}, "50x8往返跑": {"60": 144, "80": 128}, "肺活量": {"60": 1150, "80": 1650}}
    },
    "初中": {
        "说明": "适用于初中7-9年级",
        "男": {"50米": {"60": 9.1, "80": 7.9}, "坐位体前屈": {"60": 3.7, "80": 12.8}, "立定跳远": {"60": 185, "80": 225}, "引体向上": {"60": 6, "80": 11}, "1000米": {"60": 275, "80": 245}, "肺活量": {"60": 2300, "80": 3400}},
        "女": {"50米": {"60": 9.5, "80": 8.5}, "坐位体前屈": {"60": 6.0, "80": 14.8}, "立定跳远": {"60": 146, "80": 176}, "仰卧起坐": {"60": 28, "80": 40}, "800米": {"60": 255, "80": 225}, "肺活量": {"60": 1800, "80": 2500}}
    },
    "高中": {
        "说明": "适用于高中10-12年级",
        "男": {"50米": {"60": 9.0, "80": 7.8}, "坐位体前屈": {"60": 5.5, "80": 14.9}, "立定跳远": {"60": 205, "80": 240}, "引体向上": {"60": 9, "80": 14}, "1000米": {"60": 265, "80": 235}, "肺活量": {"60": 2700, "80": 3800}},
        "女": {"50米": {"60": 9.4, "80": 8.7}, "坐位体前屈": {"60": 6.8, "80": 16.5}, "立定跳远": {"60": 158, "80": 182}, "仰卧起坐": {"60": 28, "80": 40}, "800米": {"60": 270, "80": 240}, "肺活量": {"60": 1850, "80": 2650}}
    },
    "大学": {
        "说明": "适用于大学1-4年级",
        "男": {"50米": {"60": 9.1, "80": 7.9}, "坐位体前屈": {"60": 3.7, "80": 14.7}, "立定跳远": {"60": 208, "80": 248}, "引体向上": {"60": 10, "80": 15}, "1000米": {"60": 272, "80": 237}, "肺活量": {"60": 3100, "80": 4300}},
        "女": {"50米": {"60": 10.3, "80": 8.9}, "坐位体前屈": {"60": 6.0, "80": 16.9}, "立定跳远": {"60": 151, "80": 178}, "仰卧起坐": {"60": 26, "80": 42}, "800米": {"60": 274, "80": 244}, "肺活量": {"60": 2000, "80": 3000}}
    }
}
...
def generate_class_report(df, level, rate, api_key):
    ...
    # 过滤出体育项目列
    score_cols = [c for c in num_cols if any(k in c for k in SCORE_COLUMNS_MAP.keys())]
    
    for col in score_cols:
        avg_val = df[col].mean()
        item_stats.append(f"{col}: 平均{avg_val:.1f}")
    
    # 2. 构造详细数据描述
    data_context = " | ".join(item_stats) if item_stats else "暂无分项数据"
    
    prompt = f"""
    【角色设定】你是一位拥有20年经验的体育特级教师和青少年体质健康专家。
    【任务】根据以下班级体测数据，撰写一份《班级体育教学专业分析与改进方案》。
    ...
    【报告要求】
    请按 Markdown 格式输出，包含以下三个板块，语气专业、客观、具有指导意义：
    
    ### 1. 📊 数据诊断 (Data Diagnosis)
    - 点评整体优良率水平。
    - 基于分项数据，一针见血地指出该班级的**强项**和**最大短板**（例如：耐力不足、上肢力量薄弱等）。
    
    ### 2. 🩺 归因分析 (Root Cause Analysis)
    - 从生理发展、日常训练习惯等方面，简要分析造成短板的可能原因。
    
    ### 3. 💊 针对性训练处方 (Training Prescription)
    - 针对最大短板，开出具体的训练菜单（列出2-3个具体的训练动作或游戏）。
    - 给出教学实施建议（如：每周频次、强度控制）。
    ...
    try:
        ...
        else: return "AI 服务响应异常，请稍后再试。"
    except Exception as e: return f"网络连接错误: {str(e)}"
